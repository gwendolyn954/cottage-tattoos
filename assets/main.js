...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-up', speed: 1000, intensity: 0, delay: 0, replay: false });
		onvisible.add('.buttons.style2', { style: 'zoom-in', speed: 1000, intensity: 0, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'blur-in', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 1000, intensity: 0, delay: 0, replay: false });
		onvisible.add('form.style1', { style: 'zoom-in', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'zoom-in', speed: 1000, intensity: 8, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
